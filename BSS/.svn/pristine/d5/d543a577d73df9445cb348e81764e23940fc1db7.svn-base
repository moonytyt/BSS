...
<hr color="black">
<div class="card" style="padding: 10px 0px 15px 0px;">
...
<div class="row mb-2">
	<div class="col-md-2">
		<select id="chartType" class="form-select" style="margin-top: 25px;margin-bottom: 10px;">
...
<div class="card">
<div id="chart1" style="overflow: hidden;padding: 10px;"></div>
</div>
<script>
